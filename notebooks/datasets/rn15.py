"""Researcher's Night at 15 fps.

A swept window over a continuous recording. Note the corpus sits at a
fixed camera angle -- median yaw 25 degrees -- which is *not* a head
turning away.
